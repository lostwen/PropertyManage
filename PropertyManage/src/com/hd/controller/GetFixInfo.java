...
public class GetFixInfo extends Base {

	public ArrayList<Map<String, Object>> getFixInfo(String sql) {
		...
		try {
			...
			while (rs.next()) {
				...
				map.put("fixItem", rs.getString("报修事项"));
				map.put("fixPeople", rs.getString("处理人"));
				map.put("fixFeedBack", rs.getString("处理反馈"));
